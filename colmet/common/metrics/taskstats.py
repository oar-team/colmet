...
class TaskstatsCounters(BaseCounters):
    ...
    counters_taskstats = {
        ...
        'cpu_count': (16, UInt64(), 'count', 'add', "Nb of cpu delay values recorded"),
        # __u64   cpu_delay_total;
        'cpu_delay_total': (24, UInt64(), 'nsec', 'add', "Total of cumulative cpu delay"),
        ...
        #  */
        # __u64   blkio_count;
        'blkio_count': (32, UInt64(), 'count', 'add', "Nb of block I/O delay values recorded"),
        # __u64   blkio_delay_total;
        'blkio_delay_total': (40, UInt64(), 'nsec', 'add', "Total of cumulative block I/O delay"),

        # /* Delay waiting for page fault I/O (swap in only) */
        # __u64   swapin_count;
        'swapin_count': (48, UInt64(), 'count', 'add', "Nb of swapin delay calues recorded"),
        # __u64   swapin_delay_total;
        'swapin_delay_total': (56, UInt64(), 'nsec', 'add', "Total of cumulative swapin delay"),
        ...
        'cpu_run_real_total': (64, UInt64(), 'nsec', 'add', "Total of cumulative cpu run real"),
        ...
        'cpu_run_virtual_total': (72, UInt64(), 'nsec', 'add', "Total of cumulative cpu run virtual"),
        ...
        # __u8    ac_sched __attribute__(aligned(8: 'none')); # /* Scheduling discipline */
        ...
        'coremem': (184, UInt64(), 'mbytes-usec', 'add', "Accumulated RSS usage"),
        # /* Accumulated virtual memory usage in duration of a task.
        #  * Same as acct_rss_mem1 above except that we keep track of VM usage.
        #  */
        # __u64   virtmem;                /* accumulated VM  usage in MB-usec */
        'virtmem': (192, UInt64(), 'mbytes-usec', 'add', "Accumulated VM usage"),

        # /* High watermark of RSS and virtual memory usage in duration of
        #  * a task, in KBytes.
        #  */
        # __u64   hiwater_rss;            /* High-watermark of RSS usage, in KB */
        'hiwater_rss': (200, UInt64(), 'kbytes', 'max', "High-watermark of RSS usage"),
        ...
        'cancelled_write_bytes': (264, UInt64(), 'bytes', 'add', "Cancelled write I/O"),

        # __u64  nvcsw;                   /* voluntary_ctxt_switches */
        'nvcsw': (272, UInt64(), 'count', 'add', "Voluntary context switches"),

        # __u64  nivcsw;                  /* nonvoluntary_ctxt_switches */
        'nivcsw': (280, UInt64(), 'count', 'add', "Non-volontary context switches"),
        # /* time accounting for SMT machines */
        # __u64   ac_utimescaled;         /* utime scaled on frequency etc */
        'ac_utimescaled': (288, UInt64(), 'usec', 'add', "User CPU time scaled on frequency"),
        # __u64   ac_stimescaled;         /* stime scaled on frequency etc */
        'ac_stimescaled': (296, UInt64(), 'usec', 'add', "System CPU time scaled on frequency"),
        # __u64   cpu_scaled_run_real_total; /* scaled cpu_run_real_total */
        'cpu_scaled_run_real_total': (304, UInt64(), 'nsec', 'add', "CPU run real total scaled on frequency"),

        # /* Delay waiting for memory reclaim */
        # __u64   freepages_count;
        'freepages_count': (312, UInt64(), 'count', 'add', "Number of freepages delay values recorded"),
        # __u64   freepages_delay_total;
        'freepages_delay_total': (320, UInt64(), 'nsec', 'add', "Total of cumulative freepages delay"),
    }
